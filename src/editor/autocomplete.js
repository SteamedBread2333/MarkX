...
function getMarkdownCompletions() {
    ...
    { name: 'code-katex', value: '```katex\n$${1:x}$\n```\n', meta: 'KaTeX', score: 900 },
    { name: 'katex', value: '```katex\n$${1:x}$\n```\n', meta: 'KaTeX', score: 1000 },
    { name: 'katex-inline', value: '```katex\n$${1:x}$\n```\n', meta: 'KaTeX Inline', score: 950 },
    { name: 'katex-block', value: '```katex\n$$\n${1:x}\n$$\n```\n\n', meta: 'KaTeX Block', score: 950 },
    { name: 'katex-fraction', value: '```katex\n$\\frac{${1:a}}{${2:b}}$\n```\n', meta: 'KaTeX Fraction', score: 900 },
    { name: 'katex-sqrt', value: '```katex\n$\\sqrt{${1:x}}$\n```\n', meta: 'KaTeX Square Root', score: 900 },
    { name: 'katex-sum', value: '```katex\n$\\sum_{${1:i=1}}^{${2:n}} ${3:a_i}$\n```\n', meta: 'KaTeX Sum', score: 900 },
    { name: 'katex-integral', value: '```katex\n$\\int_{${1:a}}^{${2:b}} ${3:f(x)}dx$\n```\n', meta: 'KaTeX Integral', score: 900 },
    { name: 'katex-matrix', value: '```katex\n$$\n\\begin{bmatrix}\n${1:a} & ${2:b} \\\\\n${3:c} & ${4:d}\n\\end{bmatrix}\n$$\n```\n\n', meta: 'KaTeX Matrix', score: 900 },
    { name: 'katex-equation', value: '```katex\n$$\n\\begin{align}\n${1:y} &= ${2:ax + b} \\\\\n&= ${3:' + ph('result') + '}\n\\end{align}\n$$\n```\n\n', meta: 'KaTeX Equation', score: 850 },
    ...
    // 只有顶层的 ```katex 才会被解析
    { name: 'math-inline', value: '```katex\n$${1:x}$\n```\n', meta: t('ui.help.sections.templates.items.math-inline'), score: 950 },
    { name: 'math-block', value: '```katex\n$$\n${1:x}\n$$\n```\n\n', meta: t('ui.help.sections.templates.items.math-block'), score: 950 },
    { name: 'math-fraction', value: '```katex\n$\\frac{${1:a}}{${2:b}}$\n```\n', meta: t('ui.help.sections.templates.items.math-fraction'), score: 900 },
    { name: 'math-sqrt', value: '```katex\n$\\sqrt{${1:x}}$\n```\n', meta: t('ui.help.sections.templates.items.math-sqrt'), score: 900 },
    { name: 'math-nth-root', value: '```katex\n$\\sqrt[${1:n}]{${2:x}}$\n```\n', meta: t('autocomplete.meta.mathNthRoot'), score: 850 },
    { name: 'math-sum', value: '```katex\n$\\sum_{${1:i=1}}^{${2:n}} ${3:a_i}$\n```\n', meta: t('ui.help.sections.templates.items.math-sum'), score: 900 },
    { name: 'math-product', value: '```katex\n$\\prod_{${1:i=1}}^{${2:n}} ${3:a_i}$\n```\n', meta: t('autocomplete.meta.mathProduct'), score: 850 },
    { name: 'math-integral', value: '```katex\n$\\int_{${1:a}}^{${2:b}} ${3:f(x)}dx$\n```\n', meta: t('ui.help.sections.templates.items.math-integral'), score: 900 },
    { name: 'math-double-integral', value: '```katex\n$\\iint_{${1:D}} ${2:f(x,y)}dxdy$\n```\n', meta: t('autocomplete.meta.mathDoubleIntegral'), score: 800 },
    { name: 'math-limit', value: '```katex\n$\\lim_{${1:x} \\to ${2:\\infty}} ${3:f(x)}$\n```\n', meta: t('ui.help.sections.templates.items.math-limit'), score: 900 },
    { name: 'math-derivative', value: '```katex\n$\\frac{d${1:f}}{d${2:x}}$\n```\n', meta: t('autocomplete.meta.mathDerivative'), score: 850 },
    { name: 'math-partial', value: '```katex\n$\\frac{\\partial ${1:f}}{\\partial ${2:x}}$\n```\n', meta: t('autocomplete.meta.mathPartial'), score: 850 },
    { name: 'math-matrix', value: '```katex\n$$\n\\begin{bmatrix}\n${1:a} & ${2:b} \\\\\n${3:c} & ${4:d}\n\\end{bmatrix}\n$$\n```\n\n', meta: t('ui.help.sections.templates.items.math-matrix'), score: 900 },
    { name: 'math-determinant', value: '```katex\n$$\n\\begin{vmatrix}\n${1:a} & ${2:b} \\\\\n${3:c} & ${4:d}\n\\end{vmatrix}\n$$\n```\n', meta: t('autocomplete.meta.mathDeterminant'), score: 850 },
    { name: 'math-vector', value: '```katex\n$\\vec{${1{v}}}$\n```\n', meta: t('autocomplete.meta.mathVector'), score: 850 },
    { name: 'math-norm', value: '```katex\n$\\|${1{x}}\\|$\n```\n', meta: t('autocomplete.meta.mathNorm'), score: 800 },
    { name: 'math-set', value: '```katex\n$\\{${1:1, 2, 3}\\}$\n```\n', meta: t('autocomplete.meta.mathSet'), score: 850 },
    { name: 'math-set-operations', value: '```katex\n$${1:A} \\cup ${2:B}$\n```\n', meta: t('autocomplete.meta.mathSetOperations'), score: 800 },
    { name: 'math-binomial', value: '```katex\n$\\binom{${1:n}}{${2:k}}$\n```\n', meta: t('autocomplete.meta.mathBinomial'), score: 800 },
    { name: 'math-equation', value: '```katex\n$$\n\\begin{align}\n${1:y} &= ${2:ax + b} \\\\\n&= ${3:' + ph('result') + '}\n\\end{align}\n$$\n```\n\n', meta: t('autocomplete.meta.mathEquation'), score: 850 },
    { name: 'math-cases', value: '```katex\n$$\n${1:f(x)} = \\begin{cases}\n  ${2:x} & \\text{if } ${3:x > 0} \\\\\n  ${4:0} & \\text{otherwise}\n\\end{cases}\n$$\n```\n\n', meta: t('autocomplete.meta.mathCases'), score: 850 },
